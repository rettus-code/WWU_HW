...
(-e "/home/clausoa/bin/dlc" and -x "/home/clausoa/bin/dlc")
...
if ($USE_BTEST) {
    $driverfiles = "Makefile btest.c decl.c tests.c btest.h bits.h";
...
#
print "1. Running '/home/clausoa/bin/dlc -z' to identify coding rules violations.\n";
system("cp bits.c save-bits.c") == 0
    or die "$0: ERROR: Could not create backup copy of bits.c. $diemsg\n";
system("/home/clausoa/bin/dlc -z -o zap-bits.c bits.c") == 0
...
# 
print "\n3. Running '/home/clausoa/bin/dlc -Z' to identify operator count violations.\n";
system("/home/clausoa/bin/dlc -Z -o Zap-bits.c save-bits.c") == 0
...
#
print "\n5. Running '/home/clausoa/bin/dlc -e' to get operator count of each function.\n";
$status = system("/home/clausoa/bin/dlc -W1 -e zap-bits.c > dlc-opcount.out 2>&1");
if ($status != 0) {
